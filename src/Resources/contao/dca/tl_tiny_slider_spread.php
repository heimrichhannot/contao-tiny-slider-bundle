...
$GLOBALS['TL_DCA']['tl_tiny_slider_spread'] = [
    ...
    'subpalettes' => [
        'addTinySlider' => '
                            ...
                            tinySlider_onInit,
                            tinySlider_enhanceAccessibility,
							cssClass
							',
    ...
    'fields' => [
        ...
        'tinySlider_responsive' => [
            ...
            'eval' => [
                'tl_class' => 'clr',
                'multiColumnEditor' => [
                    'editorTemplate' => 'multi_column_editor_tinySlider_responsive',
                    'fields' => [
                        'breakpoint' => [
        ...
        'tinySlider_enhanceAccessibility' => [
            'label' => &$GLOBALS['TL_LANG']['tl_tiny_slider_spread']['tinySlider_enhanceAccessibility'],
            'inputType' => 'checkbox',
            'exclude' => true,
            'default' => true,
            'eval' => [
        ...
        'tinySlider_displayPageNumber' => [
            'label' => &$GLOBALS['TL_LANG']['tl_tiny_slider_spread']['tinySlider_displayPageNumber'],
            'inputType' => 'checkbox',
            'exclude' => true,
            'default' => false,
            'eval' => [
