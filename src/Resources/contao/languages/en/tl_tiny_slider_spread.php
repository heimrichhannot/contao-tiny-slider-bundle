...
$lang['tinySlider_controlsTextPrev']          = ['Controls prev text', 'Text or markup in the prev buttons. Default: prev'];
$lang['tinySlider_controlsTextNext']          = ['Controls prev text', 'Text or markup in the next buttons. Default: next'];
...
$lang['tinySlider_animateNormal']             = ['Outro animation', 'Name of default animation class. Default: tns-normal'];
...
$lang['tinySlider_responsive_config']         = ['Configuration', ''];
...
$lang['tinySlider_disable']                   = ['Disable', 'Disable slider. Default: false'];
